#!/usr/bin/env python3
"""Apply strict publication governance to gold outputs."""
from __future__ import annotations
import json
from pathlib import Path
ROOT=Path(__file__).resolve().parents[2]; LATEST=ROOT/'docs/gold/data/latest.json'; CAL=ROOT/'docs/gold/data/weekly_calibration.json'
def main():
